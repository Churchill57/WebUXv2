...
namespace WebUXv2.Controllers
{
    public class CustomerCrudController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Title,FirstName,LastName,DOB,NINO")] Customer customer)
        {
        ...
        [HttpPost]
        //[ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Title,FirstName,LastName,DOB,NINO")] Customer customer)
        {
            if (ModelState.IsValid)
            {
